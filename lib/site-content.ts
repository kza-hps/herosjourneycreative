  ...
  },
  {
    ...
    detail: {
      ...
      summary: {
        ...
        whyItExists:
          "Most speculative frameworks of this kind stay as assertion — compelling to their author, untestable by anyone else. This project exists to do the harder thing: take a big cross-disciplinary idea, subject it to genuine adversarial critique, and reduce it to a single prediction that could come out against it. It is an experiment in holding your own ideas to a standard that can disprove them, in public.",
        whatWasBuilt:
